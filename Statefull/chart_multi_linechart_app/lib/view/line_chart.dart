import 'package:chart_multi_linechart_app/model/developer_data.dart';
...
class _LineChartState extends State<LineChart> {
  ...
  late List<DeveloperData> dataTwo; 
  ...
  addData(){ // 하나의 화면에서 움직이기 때문에 async를 쓸 필요가 없다.
    ...
    dataTwo.add(DeveloperData(year: 2017, developers: 9000));
    dataTwo.add(DeveloperData(year: 2018, developers: 20000));
    dataTwo.add(DeveloperData(year: 2019, developers: 17000));
    dataTwo.add(DeveloperData(year: 2020, developers: 18000));
    dataTwo.add(DeveloperData(year: 2021, developers: 23000));
  }
